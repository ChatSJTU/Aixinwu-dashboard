...
const ReportUserView: React.FC = () => {
  ...
  const [userReportsQuery, userReportsQueryOpts] = useCustomerReportsLazyQuery({
    onCompleted: data => {
      setButtonState("default");
      doDraw(data.customerReports);
    },
    onError: err => {
      setButtonState("default");
      notify({
  ...
  const doDraw = (data: CustomerReportsQuery['customerReports']) => {
      ...
      <div style={{width: '100%', height: '60vh'}}>
        <ResponsiveContainer >
          ...
          >
            ...
            <YAxis yAxisId="y1" style={{fontSize: '12px'}} minTickGap={1} allowDecimals={false}/>
