...
export type DonationKeySpecifier = ('barcode' | 'createdAt' | 'description' | 'donator' | 'id' | 'number' | 'price' | 'quantity' | 'status' | 'title' | 'updatedAt' | DonationKeySpecifier)[];
